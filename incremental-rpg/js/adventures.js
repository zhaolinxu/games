var adventures = [ // name, lvl, minMonsters, maxMonsters, maxHp, minHp, maxDmg, minDmg, maxGold, minGold, maxXp, minXp
	new Adventure("平原", 				1, 	2, 	4, 	40, 	25,		5, 		3, 		20, 	10, 	20, 	10),
	new Adventure("山洞", 				3, 	3, 	6, 	75, 	50, 	7, 		5, 		40, 	20, 	40,		20),
	new Adventure("圣木", 			7, 	5, 	7, 	125, 	100,	25,		15,		80,		40,		80, 	40),
	new Adventure("龙窟",			12,	7,	10,	200,	150,	40,		30,		500,	350, 	200,	150),
	new Adventure("鬼村",		15,	7,	10,	300,	200,	55,		40,		1500,	1000,	750,	500),
	new Adventure("达华旺城堡",		20,	5,	8,	750,	600,	65,		55,		3000,	1750,	1000,	750),
	new Adventure("医院",			30,	4,	8,	1200,	1000,	100,	80,		6000,	5000,	2000,	1500),
	new Adventure("克拉普斯森林",			40,	4,	7,	1600,	1400,	150,	125,	10000,	8000,	3500,	2750),
	new Adventure("深部宿舍",		50,	9,	12,	2000,	1800,	200,	150,	15000,	12500,	5000,	4000)
];
var liveAdventure;
...
Adventure.init = function() {
	...
	for (var i = 0; i < adventures.length; i++) {
		var a = adventures[i];
		$("#a-n" + (i+1)).html(a.name + " - 所需等级 : " + a.reqLevel);
		$("#a-m" + (i+1)).html(a.minMonsters + " 到 " + a.maxMonsters + " 个怪物");
	};	
};