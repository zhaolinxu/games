...
var weedPriceUpgrades = [
    ...
    new Upgrade("转基因大麻 I",		        75000000000000000000,	    function() { drugMultiplier[0] *= 2 },    "weed price x2"),
	new Upgrade("转基因大麻 II",             125000000000000000000,      function() { drugMultiplier[0] *= 2 },    "weed price x2"),
	new Upgrade("转基因大麻 III",	        725000000000000000000,	    function() { drugMultiplier[0] *= 3 },    "weed price x3"),
    new Upgrade("转基因大麻 IV",	            1750000000000000000000,	    function() { drugMultiplier[0] *= 2 },    "weed price x2"),
	new Upgrade("转基因大麻 V",              12500000000000000000000,    function() { drugMultiplier[0] *= 2 },    "weed price x2"),
    new Upgrade("另一大麻价格升级...",            150000000000000000000000,   function() { drugMultiplier[0] *= 3 },    "weed price x3"),
    new Upgrade("另一大麻价格升级...",            650000000000000000000000,   function() { drugMultiplier[0] *= 2 },    "weed price x2"),
    new Upgrade("另一大麻价格升级...",            1250000000000000000000000,  function() { drugMultiplier[0] *= 3 },    "weed price x3"),
    new Upgrade("另一大麻价格升级...",            150000000000000000000000000,    function() { drugMultiplier[0] *= 2 },    "weed price x2"),
    new Upgrade("另一大麻价格升级...",            750000000000000000000000000,    function() { drugMultiplier[0] *= 3 },    "weed price x3")
];

var methPriceUpgradesOwned;
var methPriceUpgrades = [
    new Upgrade("化学家",                          2500000,				    function() { drugMultiplier[1] *= 3 },    "meth price x3"),
    new Upgrade("存储设备",                10000000,				    function() { drugMultiplier[1] *= 2 },    "meth price x2"),
    new Upgrade("烧杯",                          500000000,				    function() { drugMultiplier[1] *= 2 },    "meth price x2"),
    new Upgrade("烧杯 II",                       2500000000,				    function() { drugMultiplier[1] *= 3 },    "meth price x3"),
